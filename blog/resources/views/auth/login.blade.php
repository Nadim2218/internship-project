            ...
            <div class="col-xl-4 col-md-5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="password" required="" id="password" placeholder="Enter your password" value="{{ old('password') }}" name="password">
                            </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50"> <a class='text-white-50 ms-1' href='{{ route('register') }}'>Forgot your password?</a></p>
