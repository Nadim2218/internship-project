                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h2 class="text-center mb-4 text-white">Admin Sign in</h2>
                                    <form action="admin_post.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" placeholder="Enter Phone Number" name="admin_mobile">
                                        </div>
                                        
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-white text-primary btn-block">Sign Me In</button>
                                        </div>
                                        <a class="text-white" href="login.php">Go to voter login</a>
                                    </form>                                    
                                </div>
                            </div>
                        </div>
